...
public final class Queries {
    ...
    public static Set<FilterQuery> extractQueries(final Map<String, List<String>> parameters) {
    ...
    public static FilterQuery extractQuery(final String parameterName, final List<String> values) {
